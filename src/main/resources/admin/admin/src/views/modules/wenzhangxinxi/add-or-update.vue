	...
	<div class="addEdit-block" style="width: 100%;">
		...
		>
			<template >
				...
				<el-form-item :style='{"width":"45%","margin":"0 2% 20px 0","display":"inline-block"}' class="select" v-if="type!='info'"  label="文章类型" prop="wenzhangleixing">
					<el-select :disabled="ro.wenzhangleixing" v-model="ruleForm.wenzhangleixing" placeholder="请选择文章类型" >
						<el-option
							v-for="(item,index) in wenzhangleixingOptions"
							v-bind:key="index"
							:label="item"
							:value="item">
						</el-option>
				...
				<el-form-item :style='{"width":"45%","margin":"0 2% 20px 0","display":"inline-block"}' v-else class="input" label="文章类型" prop="wenzhangleixing">
					<el-input v-model="ruleForm.wenzhangleixing"
...
export default {
	...
	this.ruleForm.wenzhangneirong = this.ruleForm.wenzhangneirong.replace(reg,'../../../springboot1490x/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
