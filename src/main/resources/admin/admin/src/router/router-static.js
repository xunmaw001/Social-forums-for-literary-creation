...
import center from '@/views/center'
    ...
    import wenzhangjubao from '@/views/modules/wenzhangjubao/list'
    ...
    import jinggaoxinxi from '@/views/modules/jinggaoxinxi/list'
