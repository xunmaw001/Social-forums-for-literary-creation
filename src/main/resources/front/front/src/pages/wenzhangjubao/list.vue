...
<div>
    ...
    <el-form :inline="true" :model="formSearch" class="list-form-pv" :style='{"padding":"10px 10px 0","margin":"0 0 10px","alignItems":"center","flexWrap":"wrap","display":"flex","width":"100%","height":"auto"}'>
      ...
      <el-form-item :style='{"alignItems":"center","margin":"0 4px 0 0","display":"flex"}'>
        ...
        <el-input v-model="formSearch.wenzhangleixing" placeholder="文章类型" clearable></el-input>
      </el-form-item>
	  ...
	  <el-button v-if="isAuth('wenzhangjubao','新增')" :style='{"cursor":"pointer","border":"8px inset #ffc766","padding":"0px 15px","margin":"0 10px 0 0","outline":"none","color":"#333","borderRadius":"4px","background":"#fff","width":"auto","fontSize":"14px","lineHeight":"32px","height":"45px"}' type="primary" @click="add('/index/wenzhangjubaoAdd')"><i v-if="true" :style='{"color":"#333","margin":"0 10px 0 0","fontSize":"14px"}' class="el-icon-circle-plus-outline"></i>添加</el-button>
    </el-form>
    ...
    methods: {
      ...
      getList(page, fenlei, ref = '') {
        ...
        if (this.formSearch.wenzhangleixing != '') searchWhere.wenzhangleixing = '%' + this.formSearch.wenzhangleixing + '%';
	      params['sfsh'] = '是';
        this.$http.get('wenzhangjubao/list', {params: Object.assign(params, searchWhere)}).then(res => {
          if (res.data.code == 0) {
      ...
      toDetail(item) {
        this.$router.push({path: '/index/wenzhangjubaoDetail', query: {detailObj: JSON.stringify(item)}});
      },
    }
  }
</script>
