...
<div :style='{"width":"90%","padding":"30px 0px 40px","margin":"10px auto","position":"relative","background":"rgba(255,255,255,.0)"}'>
    ...
    >
          ...
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px"}'  label="文章类型" prop="wenzhangleixing">
            <el-select v-model="ruleForm.wenzhangleixing" placeholder="请选择文章类型" >
              <el-option
          ...
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px"}' label="文章内容" prop="wenzhangneirong">
            <editor 
  ...
  export default {
    ...
    methods: {
      ...
      init(type) {
        ...
        this.$http.get('option/wenzhangleixing/wenzhangleixing', {emulateJSON: true}).then(res => {
          if (res.data.code == 0) {
